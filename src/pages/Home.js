...
function Home() {
    ...
    function addDirectory(){
        ...
        setadddirectory('')
        setvalidation('')
        return dispatch(addDir({nama:adddirectory,personilId:user.id,parent:0}))
    }
    ...
    <div className='flex flex-col space-y-2 lg:space-y-5 w-full'>
        <div className='flex flex-col lg:flex-row space-x-1 lg:space-x-2 w-full items-center space-y-2 lg:space-y-0'>
            <div className='flex flex-row lg:flex-col w-40'>
                <p className="text-orange-500  hidden lg:block font-bold">Staff Personil</p>
                <p className='text-xs text-orange-500 self-start font-semibold block lg:hidden'>Staff Personil</p>
            </div>
